...
```java
SeatsioClient client = new SeatsioClient(Region.US, <WORKSPACE SECRET KEY>); // can be found on https://app.seats.io/workspace-settings
...
```java
SeatsioClient client = new SeatsioClient(Region.US, <WORKSPACE SECRET KEY>);
...
```java
SeatsioClient client = new SeatsioClient(Region.US, <COMPANY ADMIN KEY>);
