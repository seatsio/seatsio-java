...
seatsio-java is available on jitpack.io as a maven-style package. To use it, you must first add jitpack as a repository in build.gradle or pom.xml:
...
// build.gradle
dependencies {
  compile 'com.github.seatsio:seatsio-java:1'
}
