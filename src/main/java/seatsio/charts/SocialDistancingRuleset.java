...
public class SocialDistancingRuleset extends ValueObject {
    ...
    public SocialDistancingRuleset(int index, String name, int numberOfDisabledSeatsToTheSides, boolean disableSeatsInFrontAndBehind, int numberOfDisabledAisleSeats, int maxGroupSize, int maxOccupancyAbsolute, int maxOccupancyPercentage, boolean fixedGroupLayout, Set<String> disabledSeats, Set<String> enabledSeats) {
        this.index = index;
        this.name = name;
    ...
    public SocialDistancingRuleset(int index, String name) {
        this(index, name, 0, false, 0, 0, 0, 0, false, new HashSet<>(), new HashSet<>());
    }

    public static SocialDistancingRuleset ruleBased(int index, String name, int numberOfDisabledSeatsToTheSides, boolean disableSeatsInFrontAndBehind, int numberOfDisabledAisleSeats, int maxGroupSize, int maxOccupancyAbsolute, int maxOccupancyPercentage, Set<String> disabledSeats, Set<String> enabledSeats) {
    ...
    public static SocialDistancingRuleset fixed(int index, String name, Set<String> disabledSeats) {
        return new SocialDistancingRuleset(index, name, 0, false, 0, 0, 0, 0, true, disabledSeats, new HashSet<>());
    }
}
