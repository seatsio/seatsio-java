...
public class ChartReportsTest extends SeatsioClientTest {
    ...
    public void reportItemProperties() {
        ...
        Map<String, List<ChartObjectInfo>> report = client.chartReports.byLabel(chartKey, null);
    ...
    public void byObjectType() {
        ...
        Map<String, List<ChartObjectInfo>> report = client.chartReports.byObjectType(chartKey, null);
    ...
    public void byLabel_bookWholeTablesChart() {
        ...
        Map<String, List<ChartObjectInfo>> report = client.chartReports.byLabel(chartKey, CHART);
    ...
    public void byLabel_bookWholeTablesFalse() {
        ...
        Map<String, List<ChartObjectInfo>> report = client.chartReports.byLabel(chartKey, FALSE);
    ...
    public void byCategoryKey() {
        ...
        Map<String, List<ChartObjectInfo>> report = client.chartReports.byCategoryKey(chartKey, null);
    ...
    public void byCategoryLabel() {
        ...
        Map<String, List<ChartObjectInfo>> report = client.chartReports.byCategoryLabel(chartKey, null);
