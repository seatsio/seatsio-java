...
public class RemoveObjectsNotForSale extends SeatsioClientTest {

    @Test
    public void removeAllObjects() {
        Chart chart = client.charts.create();
        Event event = client.events.create(chart.key);
        client.events.markAsNotForSale(event.key, newArrayList("o1", "o2"), newArrayList());

        client.events.removeObjectsNotForSale(event.key, newArrayList("o1", "o2"));
    ...
    public void removeSomeObjects() {
        ...
        client.events.removeObjectsNotForSale(event.key, newArrayList("o1"));
    ...
    public void someObjectsMarkedAsForSale() {
        ...
        assertThrows(SeatsioException.class, () -> client.events.removeObjectsNotForSale(event.key, newArrayList("o2", "o3")));
    }
}
