...
public class RemoveObjectsFromChannelTest extends SeatsioClientTest {
    ...
    public void removeAreaPlaces() {
        ...
        assertThat(retrievedEvent.channels())
                .containsExactly(
                        new Channel("channelKey1", retrievedEvent.channels().get(0).id(), "channel 1", "#FFFF98", 1, Set.of(), Map.of("GA1", 20))
                );
    }
    ...
    public void removeBothObjectsAndAreaPlaces() {
        ...
        assertThat(retrievedEvent.channels())
                .containsExactly(
                        new Channel("channelKey1", retrievedEvent.channels().get(0).id(), "channel 1", "#FFFF98", 1, Set.of("A-1"), Map.of("GA1", 20))
                );
    }
}
