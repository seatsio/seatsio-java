...
public class RemoveObjectsFromChannelTest extends SeatsioClientTest {
    ...
    public void test() {
        ...
        client.events.channels.add(event.key, "channelKey1", "channel 1", "#FFFF98", 1, newHashSet("A-1", "A-2", "A-3", "A-4"));

        client.events.channels.removeObjects(event.key, "channelKey1", newHashSet("A-3", "A-4"));
