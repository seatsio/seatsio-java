...
public class RemoveChannelTest extends SeatsioClientTest {
    ...
    public void removeChannel() {
        ...
        Event event = client.events.create(chart.key(), new CreateEventParams().withChannels(List.of(
                new ChannelCreationParams("channelKey1", "channel 1", "#FFFF99", 1, null),
                new ChannelCreationParams("channelKey2", "channel 2", "#FFFF99", 2, null)
        )));
        ...
        assertThat(retrievedEvent.channels())
                ...
                .containsExactly(
                        new Channel("channelKey1", "channel 1", "#FFFF99", 1, new HashSet<>(), Map.of(), null)
                );
    }
