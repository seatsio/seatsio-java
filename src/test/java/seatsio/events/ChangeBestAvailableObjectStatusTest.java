...
public class ChangeBestAvailableObjectStatusTest extends SeatsioClientTest {
    ...
    public void objectDetails() {
        ...
        assertThat(reportItem.labels()).isEqualTo(new Labels(new LabelAndType("5", "seat"), new LabelAndType("A", "row"), null));
    ...
    public void channelKeys() {
        ...
        Event event = client.events.create(chartKey, new CreateEventParams().withChannels(List.of(
                new ChannelCreationParams("channelKey1", "channel 1", "#FFFF99", 1, Set.of("B-6"))
        )));
    ...
    public void ignoreChannels() {
        String chartKey = createTestChart();
        Event event = client.events.create(chartKey, new CreateEventParams().withChannels(List.of(
                new ChannelCreationParams("channelKey1", "channel 1", "#FFFF99", 1, Set.of("A-5"))
        )));
